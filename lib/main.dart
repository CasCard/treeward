  ...
  _plantSelector(int index){
    return AnimatedBuilder(
      ...
      child: GestureDetector(
        onTap:(){
          Navigator.push(context,MaterialPageRoute(builder: (_)=>PlantScreen(
            plant:plants[index]
          ),),);
        },
              ...
              children: <Widget>[
                Center(
                  child: Hero(
                    ...
                    child: Image(height: 280.0,width: 2800.0,image: AssetImage('assets/images/plant$index.png',),
                      fit:BoxFit.cover,
                    ),
                ...
                Positioned(
                  ...
                  children: <Widget>[
                    Text('FROM',style: TextStyle(color: Colors.white,fontSize: 15.0),),
                    Text('\$${plants[index].price}',style: TextStyle(color: Colors.white,fontSize: 25.0,
